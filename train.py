...
def main():
    ...
    for epoch in range(hp.epochs):
        ...
        dataloader = DataLoader(dataset, batch_size=hp.batch_size, shuffle=False, collate_fn=collate_fn_transformer, drop_last=True, num_workers=16)
